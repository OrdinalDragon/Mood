...
async def init_db():
    ...
    from app.models import Event, User, Ad, BannedEmail, Notification, Review
    await init_beanie(database=client[MONGO_DB_NAME], document_models=[Event, User, Ad, BannedEmail, Notification, Review])
